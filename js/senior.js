	...
	for (var i=0; i<_this.length; i++) {
		...
		if (_this[i].getAttribute('data-ptr') == null) {
			if (getTheStyle(_this[i], 'display') == 'none' || getTheStyle(_this[i], 'opacity') == 0 || getTheStyle(_this[i], 'height') == 0) {
				...
				_this[i].css({height: thisHeight, paddingTop: thisPaddingT, paddingBottom: thisPaddingB, marginTop: thisMarginT, marginBottom: thisMarginB});
				_this[i].animation({
						height: Height,
						paddingTop: paddingT,
						paddingBottom: paddingB,
...
HTMLElement.prototype.slideDown = function(time, Easing, callback) {
	...
	if (_this.getAttribute('data-ptr') == null) {
		if (getTheStyle(_this, 'display') == 'none' || getTheStyle(_this, 'opacity') == 0 || getTheStyle(_this, 'height') == 0) {
			...
			_this.css({height: thisHeight, paddingTop: thisPaddingT, paddingBottom: thisPaddingB, marginTop: thisMarginT, marginBottom: thisMarginB});
			_this.animation({
					height: Height,
					paddingTop: paddingT,
					paddingBottom: paddingB,
...
Array.prototype.animation = function(properties, duration, callback) {
	if (this.length <= 0)
		return false;
	var end = properties;
	for (var i=0; i<this.length; i++) {
...
HTMLElement.prototype.animation = function(properties, duration, callback) {
	if (this == undefined)
		return false;
	var _this = this;
	var end = properties;
